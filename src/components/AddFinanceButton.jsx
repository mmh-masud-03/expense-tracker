  ...
  return (
    <>
      ...
      <motion.button
        ...
        onClick={toggleModal}
        className={
          "fixed 2xl:size-36 2xl:animate-pulse flex justify-center items-center bottom-6 right-6 p-4 bg-slate-700 text-white rounded-full shadow-lg hover:bg-slate-900 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
        }
